...
* Objetivos: 	Costear ConectaIdeas
* ********************************************************************* *
* ********************************************************************* *
...
* ******************************************************************** *
	...
	* Exportar Padrón de IIEE Focalizadas
	...
	export excel "$output/Padrón_ConectaIdeas.xlsx", sheet ("Padrón_ConectaIdeas") replace firstrow(variables) locale(es)
...
* ******************************************************************** *
	...
	* ---------------------
	...
	export excel "$output/PxQ_DREUGEL_ConectaIdeas.xlsx", sheet ("PXQ_DREUGEL_ConectaIdeas") replace firstrow(variables) locale(es)
	...
	* ---------------------
	...
	export excel "$output/PxQ_UE_ConectaIdeas.xlsx", sheet ("PXQ_UE_ConectaIdeas") replace firstrow(variables) locale(es)
