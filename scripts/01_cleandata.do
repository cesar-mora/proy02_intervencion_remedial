...
rename ANEXO anexo
keep cod_mod anexo CODLOCAL D_ESTADO D_FORMA D_TIPSSEXO D_GESTION D_GES_DEP DAREACENSO CODOOII D_DREUGEL D_COD_CAR NLAT_IE NLONG_IE D_NIV_MOD D_GESTION D_REGION
